...
public class Dot11BssidList extends Structure {
  ...
  /**
   * An NDIS_OBJECT_HEADER structure that contains the type, version, and size information of an
   * NDIS structure. For most DOT11_BSSID_LIST structures, set the Type member to
   * NDIS_OBJECT_TYPE_DEFAULT, set the Revision member to DOT11_BSSID_LIST_REVISION_1, and set the
   * Size member to sizeof(DOT11_BSSID_LIST).
   */
