...
public class WlanAvailableNetworkList extends Structure {
   ...
   * dwNumberOfItems.
   *
   * This member is not used by the wireless service. Applications can use this member when
   * processing individual networks in the WLAN_AVAILABLE_NETWORK_LIST structure. When an
   * application passes this structure from one function to another, it can set the value of dwIndex
   * to the index of the item currently being processed. This can help an application maintain
   * state.
   *
  ...
  public static class ByReference extends WlanAvailableNetworkList implements
