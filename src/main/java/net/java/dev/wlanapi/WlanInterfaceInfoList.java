...
public class WlanInterfaceInfoList extends Structure {
   ...
   * processing individual interfaces in the WLAN_INTERFACE_INFO_LIST structure. When an application
   * passes this structure from one function to another, it can set the value of dwIndex to the
   * index of the item currently being processed. This can help an application maintain state.
   *
