...
public class WlanConnectionNotificationData extends Structure {
  ...
  protected List<String> getFieldOrder() {
    return Arrays.asList("wlanConnectionMode", "strProfileName", "dot11Ssid", "dot11BssType",
        "bSecurityEnabled",
        "wlanReasonCode", "dwFlags", "strProfileXml");
  }

  public static class ByReference extends WlanConnectionNotificationData implements
